...
2. `docs/` is tracked in version control and pushed (either the `flowos/` repo relocated to workspace root, or docs moved into the repo — a 30-minute decision, decided once, recorded in `docs/execution/logs/decision-log.md`).
...
| WP | Purpose | Effort |
|----|---------|--------|
| **WP-5.1 Retention dossier + decision memo** | All cohort data, interview synthesis, churn reasons; binary GO/CONTRACT decision, dated, in `docs/execution/logs/decision-log.md` | 1–2 d |
