...
~10 minute reading path for product direction and current execution.
...
| Read | Why |
|------|-----|
| [execution/README.md](../execution/README.md) | Current milestone (M2), what's shipped, what's left |
