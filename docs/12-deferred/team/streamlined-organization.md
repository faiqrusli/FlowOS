...
**Read:** `docs/10-team/roles/founder.md`
...
Read: docs/10-team/streamlined-organization.md (Role 2)
...
Read: docs/10-team/streamlined-organization.md (Role 3)
...
Read: docs/10-team/streamlined-organization.md (Role 4)
