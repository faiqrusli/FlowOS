...
This handbook coordinates work. It does not replace the [Vision](../00-constitution/Vision.md), product and feature contracts, architecture documents, the [MVP Implementation Masterplan](./mvp-implementation-masterplan.md), or release plans.
...
The canonical standard for durable review records is [Review Records](../09-reviews/review-records.md).
