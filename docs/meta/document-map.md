...
[../archive/foundation/](../archive/foundation/) — IA, metrics, personas, CEO review, governance pass report, validation report, product strategy, philosophy, competitor analysis, risk register, deployment readiness.
...
3. governance/ (PRINCIPLES, GATES, QUALITY, ENGINEERING)
4. foundation/ + execution/
5. archive/
