...
| Phase 3 UX strategy | `docs/design/ux-friction-review.md` + `ROADMAP.md` |
...
Full Phase 3 breakdown: [ROADMAP.md](./ROADMAP.md) and [ux-friction-review.md](./ux-friction-review.md).
