...
None — review only. Implementation will touch routing, layout, command layer, capture, focus, and scheduling files listed in [ROADMAP.md](./ROADMAP.md).
...
- [ROADMAP.md](./ROADMAP.md) — Phase 3.1–3.6 detailed breakdown  
- [PROJECT_STATE.md](./PROJECT_STATE.md) — current UX debt summary  
