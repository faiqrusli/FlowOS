...
| [PROJECT_STATE.md](./PROJECT_STATE.md) | Current project snapshot | Living document |
| [ROADMAP.md](./ROADMAP.md) | Approved future phases | Living document |
...
2. [ROADMAP.md](./ROADMAP.md) — Phase 3 only  
...
3. [PROJECT_STATE.md](./PROJECT_STATE.md) — deferred work and debt  
...
| Current state update | update `PROJECT_STATE.md` and `ROADMAP.md` | `docs/design/` |
