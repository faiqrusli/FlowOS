...
### Governance layer (`docs/00-constitution/governance/`)
...
| [11-archive/foundation/COMPETITOR_ANALYSIS.md](./governance/11-archive/foundation/COMPETITOR_ANALYSIS.md) | 10 competitors; learn vs differ |
...
| [11-archive/foundation/RISK_REGISTER.md](./governance/11-archive/foundation/RISK_REGISTER.md) | 30+ tracked risks |

This report: `11-archive/foundation/GOVERNANCE_PASS_REPORT.md`
...
| [PROJECT_STATE.md](../11-archive/design/project-state-july-2026.md) | Module map corrected to match code |
...
12. Log decisions in [decision-log.md](../current-phase/logs/decision-log.md)  
...
1. [11-archive/foundation/CEO_REVIEW_JULY_2026.md](./11-archive/foundation/CEO_REVIEW_JULY_2026.md) — honest current state  
...
5. [11-archive/design/project-state-july-2026.md](../11-archive/design/project-state-july-2026.md) + [ROADMAP.md](../11-archive/design/roadmap-pre-masterplan.md) — design system + Phase 3 execution  
...
Every document in `docs/00-constitution/governance/` earns its place:
...
- [11-archive/foundation/CEO_REVIEW_JULY_2026.md](./11-archive/foundation/CEO_REVIEW_JULY_2026.md)  
- [../11-archive/design/roadmap-pre-masterplan.md](../11-archive/design/roadmap-pre-masterplan.md)  
