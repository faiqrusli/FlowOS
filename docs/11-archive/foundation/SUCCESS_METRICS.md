...
> **Status: Superseded (July 4, 2026)** — Metric definitions merged into [governance/GATES.md](../00-constitution/governance/GATES.md). Historical copy preserved.
...
Governance: [PRODUCT_VISION.md](./PRODUCT_VISION.md). Release gates: [governance/GATES.md](./governance/GATES.md).
...
Source: [../11-archive/design/roadmap-pre-masterplan.md](../11-archive/design/roadmap-pre-masterplan.md)
...
- [governance/GATES.md](./governance/GATES.md) — alpha and beta gates  
- [launch-plan-july-2026.md](../11-archive/planning/launch-plan-july-2026.md) — timeline tied to these metrics  
- [USER_PERSONAS.md](./USER_PERSONAS.md) — who to measure  
- [PRODUCT_VISION.md](./PRODUCT_VISION.md) — what success looks like  
- [../11-archive/design/roadmap-pre-masterplan.md](../11-archive/design/roadmap-pre-masterplan.md) — Phase 3 UX metrics  
