...
Source: [../11-archive/design/03-phase2-spec.md](../11-archive/design/03-phase2-spec.md)
...
**Rule:** Product and engineering changes above trivial bug fixes follow the same discipline. Record decisions in [decision-log.md](../current-phase/logs/decision-log.md).
...
Source: [../11-archive/design/project-state-july-2026.md](../11-archive/design/project-state-july-2026.md)
...
- [decision-log.md](../current-phase/logs/decision-log.md) — product-level decisions  
