...
> **Status: Superseded (July 4, 2026)** — IA content merged into [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md) (Information architecture section). Historical copy preserved.
...
Source: [../11-archive/design/ux-friction-review.md](../11-archive/design/ux-friction-review.md)
...
| | |
|---|---|
| **Why it exists** | Centralized KPIs, next-action computation ([thesis Ch.1](../11-archive/project/01-introduction.md)) |
...
| | |
|---|---|
| **Why it exists** | Habit formation and daily tracking ([Ch.2](../11-archive/project/02-related-works.md)) |
...
| | |
|---|---|
| **Why it exists** | Pomodoro/deep work; session tracking ([Ch.2](../11-archive/project/02-related-works.md)) |
| **SRL phase** | Performance |
...
Full breakdown: [../11-archive/design/roadmap-pre-masterplan.md](../11-archive/design/roadmap-pre-masterplan.md) Phase 3.1–3.2
...
- [../11-archive/design/ux-friction-review.md](../11-archive/design/ux-friction-review.md) — friction diagnosis  
- [../11-archive/design/roadmap-pre-masterplan.md](../11-archive/design/roadmap-pre-masterplan.md) — Phase 3 implementation plan  
