...
12. **Review Documents** (Release Manager)
    - [ ] `docs/09-reviews/post-release-learning-records.md`
...
- [Active 6-Role Configuration](../10-team/active-6-role/README.md) — Team structure
- [Authority Matrix](../10-team/authority-matrix.md) — Who can do what
