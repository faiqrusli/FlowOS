...
- **Product strategy and vision** → See [Vision](../00-constitution/Vision.md) and [Product Model](../01-product/product-model.md)
...
- **Code style conventions** → See [CODE_STANDARDS.md](../00-constitution/governance/CODE_STANDARDS.md)
- **Current implementation details** → See [TECHNICAL_ARCHITECTURE.md](../06-engineering/TECHNICAL_ARCHITECTURE.md)
...
Follow [Git Workflow](../00-constitution/governance/GIT_WORKFLOW.md):
...
|------|---------------|---------------|-------------|
| **Product** | User-facing change | Passes [PRINCIPLES.md](../00-constitution/governance/PRINCIPLES.md) feature test | Founder review |
| **UX** | Workflow, nav, routing, capture | Reduces clicks/switches; improves daily loop | Founder + Designer review |
| **Architecture** | Routes, data model, lib boundaries | Matches [TECHNICAL_ARCHITECTURE.md](../06-engineering/TECHNICAL_ARCHITECTURE.md) | Founder + Engineer review |
...
- `docs/09-reviews/records/review-record-template.md`
...
|---------------|-------|--------------|----------|
| **Vision** | Founder | Rarely (immutable philosophy) | `docs/00-constitution/Vision.md` |
...
| **Technical Details** | Engineer | Implementation changes | `docs/06-engineering/TECHNICAL_ARCHITECTURE.md` |
| **Feature Inventory** | Engineer (Founder approves) | Feature status changes | `docs/04-features/FEATURE_INVENTORY.md` |
| **Decision Records** | Founder | Consequential decision made | `docs/08-decisions/records/` |
| **Review Records** | Reviewer (Founder final) | Review completed | `docs/09-reviews/records/` |
...
| **Learning Records** | Observer (Founder decides) | Post-release insights | `docs/09-reviews/post-release/` |
...
3. ✅ **Vision** — `docs/00-constitution/Vision.md`
...
- **Technical Architecture** — `docs/06-engineering/TECHNICAL_ARCHITECTURE.md`
- **Feature Inventory** — `docs/04-features/FEATURE_INVENTORY.md`
...
- **Quality Gates** — `docs/00-constitution/governance/QUALITY_GATES.md`
- **Code Standards** — `docs/00-constitution/governance/CODE_STANDARDS.md`
- **Engineering Rules** — `docs/00-constitution/governance/ENGINEERING.md`

#### Recording Work
- **Decision Records** — `docs/08-decisions/decision-records.md`
- **Review Records** — `docs/09-reviews/review-records.md`
...
- `docs/08-decisions/records/decision-record-template.md`
- `docs/09-reviews/records/review-record-template.md`
- `docs/09-reviews/post-release/post-release-learning-record-template.md`
