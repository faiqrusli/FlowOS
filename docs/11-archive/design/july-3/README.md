...
These Markdown files are the **permanent, repo-local source of truth**. Canvases remain useful for visual reference but must not be treated as authoritative over `docs/11-archive/design/july-3/`.
...
| Approved engineering contract | `0N-phaseN-spec.md` | `docs/11-archive/design/july-3/` (historical) |
...
| Decision rationale (ongoing) | append to `AUDIT_HISTORY.md` or [decision-log.md](../../current-phase/logs/decision-log.md) | |
| Timeline entry | append to `CHANGELOG.md` | This archive folder |
| Current product state | [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md) | foundation/ |
