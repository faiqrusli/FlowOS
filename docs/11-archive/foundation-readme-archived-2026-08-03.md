...
**Status:** Implementation hold for review — see [../current-phase/logs/README.md](../current-phase/logs/README.md)  
...
Historical / alternate themes: [../11-archive/design/themes/](../11-archive/design/themes/) (v1, v2, Neutral Dark, Gruvbox, Everforest, Borderless snapshot, legacy navy stub path).
...
| [execution-masterplan.md](../11-archive/strategy/execution-masterplan.md) | Archived historical milestone context |
| [current-phase/logs/README.md](../current-phase/logs/README.md) | Ops index (hold / review mode) |
| [11-archive/review/milestones/](../11-archive/review/milestones/) | Historical SRAI reviews after milestone exit |
| [decision-register.md](../08-decisions/decision-register.md) | Canonical consequential decision discovery |
| [decision-log.md](../11-archive/current-phase/logs/decision-log.md) | Historical decision collection |
| [friction-log.md](../11-archive/current-phase/logs/friction-log.md) | Historical friction collection |
...
**Merged / archived (Pass 5):** [../11-archive/foundation/](../11-archive/foundation/) — IA, metrics, personas, CEO review, etc.
