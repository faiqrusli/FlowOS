...
**Scope:** Application-wide visual migration only. Original target was navy [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) stub → [archive navy v3](../../11-archive/design/themes/DESIGN_SYSTEM_navy_v3.md). **Live authority now:** [DESIGN_SYSTEM_V3.md](../05-design/DESIGN_SYSTEM_V3.md) + [DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md). Does **not** change product behaviour, persistence, routing, database logic, or feature architecture unless a visual replacement requires it.  
**Authority:** decision-log (2026-07-13 Visual Design System v3.0; 2026-07-19/20 Tokyo + V3 family). Historical: [11-archive/design/themes/](../../11-archive/design/themes/).  
...
- [DESIGN_SYSTEM_V3.md](../05-design/DESIGN_SYSTEM_V3.md) + [Tokyo Night Warm](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md) - live authority
- [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) - stub → archived navy v3
- [CODE_STANDARDS.md](../00-constitution/governance/CODE_STANDARDS.md) - styling rules
