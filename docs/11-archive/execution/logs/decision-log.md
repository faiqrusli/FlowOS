...
Permanent record of **product-level** decisions with context, rationale, and rejected alternatives. Design-phase decisions remain in [../../11-archive/design/july-3/AUDIT_HISTORY.md](../../11-archive/design/july-3/AUDIT_HISTORY.md). This log covers company direction, launch strategy, and cross-cutting product choices.
...
**Alternatives rejected:** Keeping the short PRODUCT_VISION as equal authority; putting vision under foundation only; treating this as 11-archive/thesis-only.  
...
**Related:** [docs/README.md](../../README.md) · [current-phase/logs/README.md](../README.md) · [flowos-live-demo.md](../runbooks/flowos-live-demo.md)
...
**Related:** [DESIGN_SYSTEM_V3_WORKSPACE.md](../05-design/DESIGN_SYSTEM_V3_WORKSPACE.md) · [DESIGN_SYSTEM_V3_INTERACTION.md](../05-design/DESIGN_SYSTEM_V3_INTERACTION.md) · `app-settings-modal.tsx`
...
**Related:** [DESIGN_SYSTEM_V3.md](../05-design/DESIGN_SYSTEM_V3.md) · Workspace · Interaction
...
**Decision:** Adopt a three-doc V3 family as proposed implementation authority: [DESIGN_SYSTEM_V3.md](../05-design/DESIGN_SYSTEM_V3.md) (philosophy + Surface 0–10 + Soft Indigo), [DESIGN_SYSTEM_V3_WORKSPACE.md](../05-design/DESIGN_SYSTEM_V3_WORKSPACE.md) (shell, borderless, per-module maps), [DESIGN_SYSTEM_V3_INTERACTION.md](../05-design/DESIGN_SYSTEM_V3_INTERACTION.md) (type, spacing, motion, states). Borderless Workspace v1.0 absorbed into V3 Workspace (file kept as historical). Token wire-up in `globals.css` follows in a later pass.  
...
**Decision:** Adopt [Borderless Workspace v1.0](../05-design/DESIGN_SYSTEM_BORDERLESS_WORKSPACE.md) — Level 1 panels and Level 3 rows are borderless by default; borders reserved for rails, floating overlays, inputs, and dashed empty drop targets. Hierarchy from spacing + surface contrast.  
...
**Related:** [DESIGN_SYSTEM_BORDERLESS_WORKSPACE.md](../05-design/DESIGN_SYSTEM_BORDERLESS_WORKSPACE.md), [DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md)
...
**Related:** [DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md)
...
**Decision:** Adopt [DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md) as the active dark-theme implementation contract. Map FlowOS semantic tokens in `globals.css` to Tokyo Night navy surfaces. **Brand accent superseded same day** by Soft Indigo lock (see entry above); early draft used amber `#E0AF68`. Supersedes Gruvbox (same day) and Neutral Dark palette lock (2026-07-17) for the live dark theme.  
...
**Related:** [DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md) · [DESIGN_SYSTEM_GRUVBOX.md](../05-design/DESIGN_SYSTEM_GRUVBOX.md)
...
**Decision:** Adopt [DESIGN_SYSTEM_GRUVBOX.md](../05-design/DESIGN_SYSTEM_GRUVBOX.md) as the active dark-theme implementation contract. Map FlowOS semantic tokens in `globals.css` to Gruvbox paints: canvas `#282828`, nav `#1F1F1F`, base `#32302F`, raised `#3C3836`, overlay `#45403D`, primary `#D8A657` with inverse text `#282828`. Supersedes Neutral Dark palette lock (2026-07-17) and navy chrome for the live dark theme.  
...
**Related:** [DESIGN_SYSTEM_GRUVBOX.md](../05-design/DESIGN_SYSTEM_GRUVBOX.md) · [DESIGN_SYSTEM_NEUTRAL_DARK.md](../05-design/DESIGN_SYSTEM_NEUTRAL_DARK.md)
...
**Related:** [DESIGN_SYSTEM_NEUTRAL_DARK.md](../05-design/DESIGN_SYSTEM_NEUTRAL_DARK.md) · [july-log.md](./july-log.md)
...
**Decision:** Adopt [DESIGN_SYSTEM_NEUTRAL_DARK.md](../05-design/DESIGN_SYSTEM_NEUTRAL_DARK.md) as the active visual implementation contract. Core paints: environment `#1B1B1B`, work `#242429`, emphasis `#29292D`, floating `#303034`, hover `#343438`, identity `#586CF6`. Implement via `globals.css` tokens first, then shared primitives and workspaces. Preserve product behaviour; migrate styling only. [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) v3.0 remains for non-conflicting semantic/component rules and is marked superseded for palette.
...
**Related:** [DESIGN_SYSTEM_NEUTRAL_DARK.md](../05-design/DESIGN_SYSTEM_NEUTRAL_DARK.md) · [globals.css](../../../src/app/globals.css)
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · FEATURE_INVENTORY design-system status.
...
**Decision:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) is now Visual Design System v3.0, the sole authority for new visual work. It defines dark-only Canvas, Navigation, Base, Raised, Overlay, and Hover semantics; exact v3 surface, border, primary, text, spacing, radius, shadow, state, component, and workspace rules. [DESIGN_SYSTEM_v2.md](../05-design/DESIGN_SYSTEM_v2.md) preserves the former frozen Sessions 1–5 contract as historical context. No product or code behaviour changes are approved by this documentation decision; a separate runbook must govern the phased implementation.
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · [DESIGN_SYSTEM_v2.md](../05-design/DESIGN_SYSTEM_v2.md) · [design-system-v3-migration.md](../execution/runbooks/design-system-v3-migration.md) · [CODE_STANDARDS.md](../00-constitution/governance/CODE_STANDARDS.md)
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · [surface-classes.ts](../../../src/lib/theme/surface-classes.ts) · [task-group-appearance.ts](../../../src/lib/task-group-appearance.ts)
...
**Decision:** Reset `main` to Sessions **1–5** tip (`33928bb`). Freeze **Layer 0–5** in [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md): Navigation → Workspace → Standard surfaces → Hero → Interactive → Feedback. Sessions 1–5 Today + nav are the visual source of truth. Discard Sessions 6–14 product commits and related branches.  
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · tip `33928bb`
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · [m2-visual-design-v2.md](../runbooks/m2-visual-design-v2.md)
...
**Decision:** Keep [DESIGN_SYSTEM_v1.md](../05-design/DESIGN_SYSTEM_v1.md) as historical context. Make [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) **v2.0 Frozen** the single source of truth for visual architecture. Preserve the four surface levels; document workspace architecture (pages vs drawer), one visual hero per screen, and frozen decisions / acceptance criteria. Token depths may refine in `globals.css` without a new major version while the four roles hold.  
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · [DESIGN_SYSTEM_v1.md](../05-design/DESIGN_SYSTEM_v1.md)
...
**Decision:** Keep [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) as the single visual authority. Restore deep-navy four-token depths (sidebar recessed below canvas). Focus card may use a **whisper** `--surface-focus` lift — edit DESIGN_SYSTEM when adjusting; do not add parallel hierarchy specs.  
...
**Related:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) · [m2-surface-hierarchy.md](../runbooks/m2-surface-hierarchy.md)
...
**Related:** [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md)
...
**Decision:** Adopt the visual design system in [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) as the authoritative surface model for all UI work:
...
**Decision:** Add [GIT_WORKFLOW.md](../00-constitution/governance/GIT_WORKFLOW.md) and Cursor rule `.cursor/rules/git-workflow.mdc`. M2 **merge bundles** B1–B5 group sessions for merge reminders; AI must ask before merge/push to `main`.  
...
**Related:** [m2-founder-daily-driver.md](../runbooks/m2-founder-daily-driver.md), [ENGINEERING.md](../00-constitution/governance/ENGINEERING.md)
...
**Decision:** Add `docs/current-phase/logs/inbox.md` (one-line capture) and `docs/current-phase/logs/july-log.md` (monthly session memory). Wire pipeline in founder daily loop and review README.  
...
**Context:** Design phases 0–2 had review/audit/post-review docs buried in `11-archive/design/`. Execution milestones (M0–M5) had runbooks and logs but no standard place to Summarize, Review, Audit, and Improve after each milestone exit.  
...
**Decision:** Reduce active foundation to **3 files**: `PRODUCT_VISION.md`, `FEATURE_INVENTORY.md` (includes IA section), `TECHNICAL_ARCHITECTURE.md`. Merge metric definitions into `governance/GATES.md`; merge M3 recruiting criteria into `execution/ops/recruiting-pipeline.md`. Archive full IA, metrics, and persona docs to `docs/11-archive/foundation/`.  
...
**Related:** [foundation README.md](../../foundation/README.md), [document-map.md](../../meta/document-map.md), [GATES.md](../00-constitution/governance/GATES.md), [recruiting-pipeline.md](../ops/recruiting-pipeline.md)
...
**Decision:** Reduce active governance to **4 files**: `PRINCIPLES.md`, `GATES.md`, `QUALITY_GATES.md`, `ENGINEERING.md`. Archive CEO review, governance pass report, validation report, product strategy, philosophy, competitor analysis, risk register, and deployment readiness to `docs/11-archive/foundation/`. Update `GATES.md` for post-M1 reality (M1 complete, M2 in progress).  
...
**Outcome:** Applied July 4, 2026.  
**Related:** [governance README.md](../00-constitution/governance/README.md), [document-map.md](../../meta/document-map.md)
...
**Decision:** Preserve as `11-archive/flowos-old` branch on `origin`; delete local `FlowOS-old/` folder.  
...
**Related:** [LAUNCH_PLAN.md](../../11-archive/planning/launch-plan-july-2026.md), [GATES.md](../00-constitution/governance/GATES.md)
...
**Outcome:** See [governance/GATES.md](../00-constitution/governance/GATES.md).  
**Related:** [governance/GATES.md](../00-constitution/governance/GATES.md)
...
**Related:** [../../11-archive/design/roadmap-pre-masterplan.md](../../11-archive/design/roadmap-pre-masterplan.md), [../../11-archive/design/ux-friction-review.md](../../11-archive/design/ux-friction-review.md)
...
**Related:** [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md) (IA section), [../../11-archive/design/AUDIT_HISTORY.md](../../11-archive/design/AUDIT_HISTORY.md)
...
**Related:** [../../11-archive/project/03-future-enhancements.md](../../11-archive/project/03-future-enhancements.md)
...
**Outcome:** See [recruiting-pipeline.md](../ops/recruiting-pipeline.md) and [USER_PERSONAS.md](../../11-archive/foundation/USER_PERSONAS.md).  
**Related:** [USER_PERSONAS.md](../../11-archive/foundation/USER_PERSONAS.md)
...
**Outcome:** See [GATES.md](../00-constitution/governance/GATES.md).  
**Related:** [GATES.md](../00-constitution/governance/GATES.md)

---

## Design decisions (reference only)

The following decisions are documented in detail in [../../11-archive/design/AUDIT_HISTORY.md](../../11-archive/design/AUDIT_HISTORY.md). Summarized here for product context:
...
- [../../11-archive/design/AUDIT_HISTORY.md](../../11-archive/design/AUDIT_HISTORY.md) — design decision rationale  
- [../../11-archive/design/CHANGELOG.md](../../11-archive/design/CHANGELOG.md) — chronological design evolution  
- [governance/PRINCIPLES.md](../00-constitution/governance/PRINCIPLES.md) — principles derived from these decisions  
- [LAUNCH_PLAN.md](../../11-archive/planning/launch-plan-july-2026.md) — decisions applied to launch timeline  
