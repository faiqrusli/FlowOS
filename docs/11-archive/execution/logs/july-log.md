...
- Developer log under `docs/current-phase/logs/developer-log/` + Cursor rule `developer-log.mdc`
...
- Visual authority: V3 family + Tokyo Night Warm; historical themes → `docs/11-archive/design/themes/` (stubs left in foundation)
- Superseded runbooks → `docs/11-archive/runbooks/`; indexes refreshed to match july-log
...
- **Neutral Dark migration:** tokens + primitives + Today/workspace surfaces; [DESIGN_SYSTEM_NEUTRAL_DARK.md](../05-design/DESIGN_SYSTEM_NEUTRAL_DARK.md)
...
- [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) v3.0 + [design-system-v3-migration.md](../runbooks/design-system-v3-migration.md) (already on `main` earlier today)
...
**Documented:** [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) Layer 2 board chrome table.
...
- Design archive moved under `11-archive/design/july-3/`
...
**Shipped (docs):**
- [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) — authoritative visual spec
