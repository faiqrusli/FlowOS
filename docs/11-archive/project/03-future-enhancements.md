...
|----|-------------|--------|-------|
| FE-1 | Goal Management | **Partial / placeholder** | `/goals` route exists; hidden from primary nav; deferred to Phase 4+ per [design ROADMAP](../design/roadmap-pre-masterplan.md) |
...
|----------|---------------------|
| FE-1 Goals | [ROADMAP.md](../design/roadmap-pre-masterplan.md) — Phase 4+ |
| FE-3 Manifesto / Agenda | [ux-friction-review.md](../design/ux-friction-review.md) — fake Agenda card (#16) |
| FE-4 AI Coach | [ROADMAP.md](../design/roadmap-pre-masterplan.md) — deferred Phase 4+ |
| FE-5 Weekly Review | [ROADMAP.md](../design/roadmap-pre-masterplan.md) — secondary in Phase 3.5 |
...
- [../design/roadmap-pre-masterplan.md](../design/roadmap-pre-masterplan.md) — current development roadmap  
- [../design/project-state-july-2026.md](../design/project-state-july-2026.md) — what is built today  
