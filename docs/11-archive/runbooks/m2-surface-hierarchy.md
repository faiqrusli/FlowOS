...
> **Historical runbook.** This records implementation of the [Visual Design System v1.0](../05-design/DESIGN_SYSTEM_v1.md) surface contract. It is not an implementation plan for [v3.0](../05-design/DESIGN_SYSTEM.md).

**Scope:** M2 only — implements the four-level v1 visual design system. Authoritative historical architecture: [DESIGN_SYSTEM_v1.md](../05-design/DESIGN_SYSTEM_v1.md). Does not add, remove, or weaken any M2 exit criterion.
...
| Spec targets | [DESIGN_SYSTEM_v1.md](../05-design/DESIGN_SYSTEM_v1.md) | Four tokens: `#0E111B`, `#121826`, `#1A2133`, `#232D45` |
...
| 3 | Update [CODE_STANDARDS.md](../00-constitution/governance/CODE_STANDARDS.md) styling section with one-line pointer to `DESIGN_SYSTEM_v1.md` (historical cross-reference). |
