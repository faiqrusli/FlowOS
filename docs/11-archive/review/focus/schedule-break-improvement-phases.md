...
Per [GIT_WORKFLOW.md](../00-constitution/governance/GIT_WORKFLOW.md): never merge to `main` without founder approval; run `npm run build && npm run lint` (and `npm test` once Phase 3 lands) before asking.
