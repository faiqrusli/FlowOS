...
- Product decision: [decision-log.md](../../current-phase/logs/decision-log.md) — 2026-07-07 Schedule Break
- Promotion: [inbox.md](../../current-phase/logs/inbox.md) — Promoted section
- Planned inventory row: [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md) — Focus sub-features
