...
Adapt these to existing FlowOS design tokens rather than duplicating if equivalents already exist (see [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md)).
...
| [DESIGN_SYSTEM.md](../05-design/DESIGN_SYSTEM.md) | Visual token authority — adapt §4 tokens to v3, do not fork a parallel palette. |
