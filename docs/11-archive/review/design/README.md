...
| **Improve** | CHANGELOG, AUDIT_HISTORY, PROJECT_STATE | [11-archive/design/july-3/](../../design/july-3/) |
...
|-------|--------|------|----------------|-------------|
| Audit | [00-design-audit.md](../../design/july-3/00-design-audit.md) | — | — | [FINAL-AUDIT-REPORT.md](../../design/july-3/FINAL-AUDIT-REPORT.md) |
| 0 | [01-phase0-review.md](../../design/july-3/01-phase0-review.md) | [01-phase0-spec.md](../../design/july-3/01-phase0-spec.md) | [01-phase0-implementation.md](../../design/july-3/01-phase0-implementation.md) | [01-phase0-post-review.md](../../design/july-3/01-phase0-post-review.md) |
| 1 | [02-phase1-review.md](../../design/july-3/02-phase1-review.md) | [02-phase1-spec.md](../../design/july-3/02-phase1-spec.md) | [02-phase1-implementation.md](../../design/july-3/02-phase1-implementation.md) | [02-phase1-post-review.md](../../design/july-3/02-phase1-post-review.md) |
| 2 | [03-phase2-strategic-review.md](../../design/july-3/03-phase2-strategic-review.md) | [03-phase2-spec.md](../../design/july-3/03-phase2-spec.md) | [03-phase2-implementation.md](../../design/july-3/03-phase2-implementation.md) | [03-phase2-post-review.md](../../design/july-3/03-phase2-post-review.md) |

### Cross-cutting reviews

| Document | Role |
|----------|------|
| [ux-friction-review.md](../../design/july-3/ux-friction-review.md) | Simulated daily loop audit — input for M2/M3 |
| [AUDIT_HISTORY.md](../../design/july-3/AUDIT_HISTORY.md) | Decision rationale index |
| [CHANGELOG.md](../../design/july-3/CHANGELOG.md) | Chronological design evolution |
...
**Retired after ship:** Application shell navigation spec/runbook — deleted after Jul 17 merge; see [july-log.md](../../current-phase/logs/july-log.md).

**Authoritative visual system:** [DESIGN_SYSTEM_V3.md](../05-design/DESIGN_SYSTEM_V3.md) · [Tokyo Night Warm](../05-design/DESIGN_SYSTEM_TOKYO_NIGHT_WARM.md) · Workspace · Interaction. Historical themes: [11-archive/design/themes/](../../design/themes/).

**Superseded Next Up V1:** [11-archive/runbooks/next-up-queue-spec.md](../../runbooks/next-up-queue-spec.md) · Historical design: [design/focus/next-up.md](../../design/focus/next-up.md)
