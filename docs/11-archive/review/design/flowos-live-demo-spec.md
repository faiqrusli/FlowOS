...
**Related:** [PRODUCT_VISION.md](../../foundation/PRODUCT_VISION.md) · [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md) · [notification-system-mvp-spec.md](./notification-system-mvp-spec.md) · [About page](../../../src/components/about/about-page-content.tsx) · [decision-log](../../current-phase/logs/decision-log.md) · [runbook](../../execution/runbooks/flowos-live-demo.md)
...
**Authority after review:** Promote accepted decisions to [decision-log.md](../../current-phase/logs/decision-log.md), then a runbook under `docs/execution/runbooks/`.
