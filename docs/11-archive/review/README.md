...
**Transition:** New durable reviews follow [Review Records](../../09-reviews/review-records.md) and are created in `docs/09-reviews/records/`. This layer is now an archived historical collection. Current implementation sequencing comes from the [MVP Implementation Masterplan](../../07-strategy-and-delivery/mvp-implementation-masterplan.md). Consequential choices now use [Decision Records](../../08-decisions/decision-records.md).
...
| **Review** | Did we achieve the exit gate? What changed next? | `docs/11-archive/review/` (here) |
| **Foundation** | What is true about the product? | [../foundation/](../foundation/) |
| **Archive** | Frozen history | [../](../) |

**Authority:** This historical SRAI layer does not override the Vision or active contracts. New consequential choices use [Decision Records](../../08-decisions/decision-records.md); new durable assessments use [Review Records](../../09-reviews/review-records.md).
...
| Event | Write |
|-------|-------|
| Design phase complete | `docs/09-reviews/records/` (current durable review) + historical evidence in [../design/july-3/](../design/july-3/) |
...
| Major external audit (CEO review, validation) | Keep in [../foundation/](../foundation/); link from relevant milestone review |
...
- [GATES.md](../00-constitution/governance/GATES.md) — release gates and metrics  
- [friction-log.md](../current-phase/logs/friction-log.md) — historical dogfood evidence (M2+)  
- [inbox.md](../current-phase/logs/inbox.md) — historical scratch UI/UX fixes  
- [july-log.md](../current-phase/logs/july-log.md) — July session memory  
