...
**Verdict:** **Incomplete snapshot** — frozen at Jul 4 engineering sessions; later Jul 17–20 ships (Today hierarchy, shell, V3/Tokyo, reminders) are in [july-log.md](../../current-phase/logs/july-log.md) / [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md). Full SRAI rewrite deferred until M2 exit or hold lift.
...
| Session 8 (dogfooding) | Open | [friction-log.md](../../current-phase/logs/friction-log.md) |
...
**Live evidence source:** [friction-log.md](../../current-phase/logs/friction-log.md) (not simulated UX review).

Historical simulated audit: [ux-friction-review.md](../../11-archive/design/july-3/ux-friction-review.md).
...
- [ ] [GATES.md](../00-constitution/governance/GATES.md) — M2 complete  
- [ ] [FEATURE_INVENTORY.md](../04-features/FEATURE_INVENTORY.md) — IA section reflects shipped Today home  
- [ ] decision-log — M2 outcome entry  
- [ ] Begin M3 SRAI planning (recruiting + D7 gate)

**Related:** [current-phase/logs/README.md](../../current-phase/logs/README.md), [friction-log.md](../../current-phase/logs/friction-log.md)
