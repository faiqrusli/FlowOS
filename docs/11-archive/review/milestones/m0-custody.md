...
|-------------|----------|
| Docs in git | [decision-log](../../current-phase/logs/decision-log.md) — 2026-07-04 docs-in-repo entry |
| FlowOS-old preserved | `11-archive/flowos-old` branch; local folder removed |
...
**Related:** [decision-log.md](../../current-phase/logs/decision-log.md)
