...
| `project-state-july-2026.md` | 5-minute project snapshot for new engineers |
| `roadmap-pre-masterplan.md` | Completed phases + Phase 3–5 plan |
...
- Phase 2 exclusions → `03-phase2-spec.md` → `project-state-july-2026.md`  
- UX friction items → `ux-friction-review.md` → `roadmap-pre-masterplan.md` Phase 3  
- Audit original Phases 3–5 → `roadmap-pre-masterplan.md` Phases 3–5 (renumbered)
