...
> **CEO review (July 2026):** Revised overall launch readiness to **3/10** due to failing production build and open RLS on core tables. See [archive/foundation/CEO_REVIEW_JULY_2026.md](./archive/foundation/CEO_REVIEW_JULY_2026.md). Objective release gates: [governance/GATES.md](./governance/GATES.md).
...
**Fix:** Phase 3.1 MVP bundle — see [../archive/design/roadmap-pre-masterplan.md](../archive/design/roadmap-pre-masterplan.md).  
**Effort:** 2–3 weeks.
...
- [launch-plan-july-2026.md](../archive/planning/launch-plan-july-2026.md) — alpha timeline and recruitment  
...
- [../archive/design/roadmap-pre-masterplan.md](../archive/design/roadmap-pre-masterplan.md) — Phase 3 work that unblocks alpha  
