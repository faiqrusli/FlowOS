...
Source: [../archive/design/03-phase2-spec.md](../archive/design/03-phase2-spec.md)
...
**Rule:** Product and engineering changes above trivial bug fixes follow the same discipline. Record decisions in [decision-log.md](../execution/logs/decision-log.md).
...
- [decision-log.md](../execution/logs/decision-log.md) — product-level decisions  
