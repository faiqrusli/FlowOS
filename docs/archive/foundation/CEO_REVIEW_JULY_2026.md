...
| Design system (Phases 0–2) | `docs/archive/design/project-state-july-2026.md`, commit `9f7e7c4` | Genuinely improved; frozen credibly at 7.8/10 visual |

**What does not work (product level):**

1. **No single daily home.** App opens on Dashboard (`/`); execution lives on Workplace (`/workplace`). Documented in [ux-friction-review.md](../archive/design/ux-friction-review.md); confirmed in `page.tsx` and `sidebar-navigation.tsx`.
...
The SRL cycle (forethought → performance → reflection) in [PRODUCT_VISION.md](./PRODUCT_VISION.md) and [../archive/project/02-related-works.md](../archive/project/02-related-works.md) is a coherent design framework. It is **not** a moat. Users do not search for "self-regulated learning apps." They search for less app switching and a clearer daily plan.
...
| Friction | Impact |
|----------|--------|
| Planning model: group vs Today vs Later vs date | High — 10–30 decisions/day ([ux-friction-review.md](../archive/design/ux-friction-review.md) #5) |
...
The UX friction review ([ux-friction-review.md](../archive/design/ux-friction-review.md)) correctly identifies the problem. But the 6-sub-phase Phase 3 plan ([ROADMAP.md](../archive/design/roadmap-pre-masterplan.md)) is **too large before first external validation** — classic solo-founder planning comfort.
...
|----------|-------|------------|
| [PROJECT_STATE.md](../archive/design/project-state-july-2026.md) module map | `/` = Today/Workplace, `/overview` = Dashboard | `/` = Dashboard, `/workplace` = Workplace, no `/overview` |
...
- [launch-plan-july-2026.md](../archive/planning/launch-plan-july-2026.md) — timeline to adjust after this review  
- [governance/GATES.md](./governance/GATES.md) — ratings revised downward here for build + RLS  
- [../archive/design/ux-friction-review.md](../archive/design/ux-friction-review.md) — workflow diagnosis **still valid**  
- [../archive/design/roadmap-pre-masterplan.md](../archive/design/roadmap-pre-masterplan.md) — Phase 3 direction valid; sequencing should change  
- [decision-log.md](../execution/logs/decision-log.md) — append outcomes from 90-day plan  
