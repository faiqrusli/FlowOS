...
> **Status: Superseded (July 4, 2026)** — Metric definitions merged into [governance/GATES.md](../../foundation/governance/GATES.md). Historical copy preserved.
...
Source: [../archive/design/roadmap-pre-masterplan.md](../archive/design/roadmap-pre-masterplan.md)
...
- [launch-plan-july-2026.md](../archive/planning/launch-plan-july-2026.md) — timeline tied to these metrics  
- [USER_PERSONAS.md](./USER_PERSONAS.md) — who to measure  
- [PRODUCT_VISION.md](./PRODUCT_VISION.md) — what success looks like  
- [../archive/design/roadmap-pre-masterplan.md](../archive/design/roadmap-pre-masterplan.md) — Phase 3 UX metrics  
