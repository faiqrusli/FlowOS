...
| G3-07 | Security, identity, validation, date/time, and recovery boundaries hold | Automated owner/validation/date/recovery assertions and migration gates are recorded; two-account RLS, Singapore boundary, accessibility, and migration application remain open | `IN_PROGRESS` |
