...
**Parent:** [Documentation Architecture](../00-constitution/documentation-architecture.md) · [Release Plans](../07-strategy-and-delivery/release-plans.md) · [Review Records](./review-records.md) · [Research Program](../12-deferred/evidence/research-program.md) · [Measurement Specifications](../12-deferred/evidence/measurement-specifications.md) · [Operations Architecture](../06-engineering/operations-architecture.md)
**Children:** Individual post-release learning records in `09-reviews/post-release/`, linked follow-up research, review, decision, delivery, and roadmap artifacts
...
Each individual record in `09-reviews/post-release/` contains:
