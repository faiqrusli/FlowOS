...
| [PRODUCT_PRINCIPLES.md](./governance/PRODUCT_PRINCIPLES.md) | 24 testable principles |
| [PRODUCT_STRATEGY.md](./governance/PRODUCT_STRATEGY.md) | 3 / 12 / 36-month strategy |
| [COMPETITOR_ANALYSIS.md](./governance/COMPETITOR_ANALYSIS.md) | 10 competitors; learn vs differ |
| [RELEASE_CRITERIA.md](./governance/RELEASE_CRITERIA.md) | 7 release stage gates |
| [ALPHA_SUCCESS_CRITERIA.md](./governance/ALPHA_SUCCESS_CRITERIA.md) | Private alpha go/no-go |
| [BETA_SUCCESS_CRITERIA.md](./governance/BETA_SUCCESS_CRITERIA.md) | Closed/public beta gates |
| [PRODUCT_DECISION_FRAMEWORK.md](./governance/PRODUCT_DECISION_FRAMEWORK.md) | Build / defer / reject |
| [ENGINEERING_DECISION_FRAMEWORK.md](./governance/ENGINEERING_DECISION_FRAMEWORK.md) | Technical priorities |
| [QUALITY_GATES.md](./governance/QUALITY_GATES.md) | Definition of done |
| [RISK_REGISTER.md](./governance/RISK_REGISTER.md) | 30+ tracked risks |

This report: `GOVERNANCE_PASS_REPORT.md`
...
| [DEPLOYMENT_READINESS.md](./DEPLOYMENT_READINESS.md) | Drift banner; revised launch readiness; build/RLS severity |
| [PROJECT_STATE.md](../design/PROJECT_STATE.md) | Module map corrected to match code |
...
|---------------------|------|-----------|
| Alpha gates in LAUNCH_PLAN | [ALPHA_SUCCESS_CRITERIA.md](./governance/ALPHA_SUCCESS_CRITERIA.md) | Objective checklist; LAUNCH_PLAN keeps timeline |
| Beta gates in LAUNCH_PLAN | [BETA_SUCCESS_CRITERIA.md](./governance/BETA_SUCCESS_CRITERIA.md) | Same |
| Deployment stage tables | [RELEASE_CRITERIA.md](./governance/RELEASE_CRITERIA.md) | DEPLOYMENT_READINESS keeps ratings; RELEASE_CRITERIA owns gates |
| Product anti-patterns in PHILOSOPHY | [PRODUCT_PRINCIPLES.md](./governance/PRODUCT_PRINCIPLES.md) | Principles = testable; philosophy = SRL/theory |
| CEO review 90-day plan | [PRODUCT_STRATEGY.md](./governance/PRODUCT_STRATEGY.md) 3-month horizon | Strategy owns horizons; CEO review stays audit record |
...
11. Use [PRODUCT_PRINCIPLES.md](./governance/PRODUCT_PRINCIPLES.md) in every feature review  
12. Log decisions in [DECISION_LOG.md](./DECISION_LOG.md)  
...
1. [CEO_REVIEW_JULY_2026.md](./CEO_REVIEW_JULY_2026.md) — honest current state  
2. [governance/PRODUCT_STRATEGY.md](./governance/PRODUCT_STRATEGY.md) + [PRODUCT_PRINCIPLES.md](./governance/PRODUCT_PRINCIPLES.md) — rules going forward  
...
5. [design/PROJECT_STATE.md](../design/PROJECT_STATE.md) + [ROADMAP.md](../design/ROADMAP.md) — design system + Phase 3 execution  
6. [governance/RELEASE_CRITERIA.md](./governance/RELEASE_CRITERIA.md) — what must happen before users  
