...
**Status:** Active — current IA documented; target IA is Phase 3.1 outcome  
...
| | |
|---|---|
| **Why it exists** | Centralized KPIs, next-action computation ([thesis Ch.1](../project/01-introduction.md)) |
...
| | |
|---|---|
| **Why it exists** | Habit formation and daily tracking ([Ch.2](../project/02-related-works.md)) |
...
| | |
|---|---|
| **Why it exists** | Pomodoro/deep work; session tracking ([Ch.2](../project/02-related-works.md)) |
| **SRL phase** | Performance |
...
Full breakdown: [../design/ROADMAP.md](../design/ROADMAP.md) Phase 3.1–3.2

---

## Related documents

- [PRODUCT_PHILOSOPHY.md](./PRODUCT_PHILOSOPHY.md) — SRL cycle and hierarchy principles  
...
- [../design/ROADMAP.md](../design/ROADMAP.md) — Phase 3 implementation plan  
