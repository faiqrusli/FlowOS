...
|---|---|---|---|---|---|
| **Today** | `/` | **Shipped** | `src/app/(main)/page.tsx`, `src/components/today/`, Workplace and dashboard composition | **Core MVP entry and reorientation surface** | [Brief](./briefs/today.md), [behavior contract](./behavior/today.md), journey contract, design spec, validation plan |
