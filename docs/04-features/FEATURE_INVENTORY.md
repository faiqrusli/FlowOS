...
| Live demo (guest) | `/login` CTA | **In progress** | Anonymous auth + seed clone; historical spec [flowos-live-demo-spec.md](../11-archive/review/design/flowos-live-demo-spec.md) · archived runbook [flowos-live-demo.md](../11-archive/execution/runbooks/flowos-live-demo.md) |
...
| Schedule reminders (MVP) | **Shipped** | Today tasks/habits → in-app toast + browser Notification API; once-only local delivery; historical spec: [notification-system-mvp-spec.md](../11-archive/review/design/notification-system-mvp-spec.md) |
...
| FE-8 | Smart Notifications | Partial | MVP schedule reminders shipped (Today toast + browser API + center); smart routing / push still deferred — [notification-system-mvp-spec.md](../11-archive/review/design/notification-system-mvp-spec.md) |
...
Full detail: [../11-archive/project/03-future-enhancements.md](../11-archive/project/03-future-enhancements.md)
...
| Visual Design System (legacy navy / v2 / Neutral Dark) | Historical | [11-archive/design/themes/](../11-archive/design/themes/) |
| Design audit / Phases 0–2 | Historical | [11-archive/design/july-3/](../11-archive/design/july-3/) |

---

## Related documents

- [../11-archive/project/03-future-enhancements.md](../11-archive/project/03-future-enhancements.md) — SRS FE-1–FE-13  
- [../04-features/feature-catalog.md](../04-features/feature-catalog.md) — canonical feature-domain coverage and documentation status
- [../current-phase/mvp-implementation-masterplan.md](../current-phase/mvp-implementation-masterplan.md) — current pre-dogfood implementation sequence
...
- [../11-archive/foundation/INFORMATION_ARCHITECTURE.md](../11-archive/foundation/INFORMATION_ARCHITECTURE.md) — full IA doc (archived)  
