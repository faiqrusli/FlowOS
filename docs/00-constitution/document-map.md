...
This is a non-normative discovery view. [Documentation Architecture](../00-constitution/documentation-architecture.md) governs document authority, lifecycle, templates, registers, and archival treatment. The canonical [Vision](../00-constitution/Vision.md) remains immutable and is not restated here.

## Active Normative Documents

| Path | Responsibility | Status | Owner | Parent |
|---|---|---|---|---|
| [../00-constitution/Vision.md](../00-constitution/Vision.md) | Constitutional product authority | Immutable | Product leadership | None |
...
| [../01-product/user-evolution-and-market-positioning.md](../01-product/user-evolution-and-market-positioning.md) | User contexts, market positioning support, and evidence-gated expansion hypotheses | Active | Product leadership | Vision and Product Strategy |
...
| [../04-features/feature-catalog.md](../04-features/feature-catalog.md) | Current feature-domain implementation status and documentation coverage | Active implementation reference | Product leadership | Information Structure and feature standards |
...
| [../05-design/design-implementation-map.md](../05-design/design-implementation-map.md) | Current design references, code authority, and migration ownership | Active implementation reference | Design leadership | Design System Architecture |
...
| [../current-phase/mvp-implementation-masterplan.md](../current-phase/mvp-implementation-masterplan.md) | Canonical pre-dogfood MVP implementation phases and readiness gates | Active | Product and engineering leadership | Vision, Product Model, and Roadmap |
| [../11-archive/strategy/documentation-refinement-plan.md](../11-archive/strategy/documentation-refinement-plan.md) | Completed documentation reconciliation plan for MVP implementation | Archived | Product and documentation leadership | Documentation Architecture and MVP Masterplan |
...
| [../12-deferred/evidence/research-program.md](../12-deferred/evidence/research-program.md) | Responsible research method, evidence integrity, and participant protection | Deferred until post-Gate 0 | Product research leadership | Product Strategy and Roadmap |
| [../12-deferred/evidence/measurement-specifications.md](../12-deferred/evidence/measurement-specifications.md) | Metric meaning, collection, provenance, quality, and revision standard | Deferred until post-Gate 0 | Product, data, and engineering leadership | Success Model and engineering architecture |
| [../12-deferred/evidence/insight-syntheses.md](../12-deferred/evidence/insight-syntheses.md) | Cross-record evidence interpretation and confidence-boundary standard | Deferred until post-Gate 0 | Product and research leadership | Research Program and Measurement Specifications |
| [../09-reviews/review-records.md](../09-reviews/review-records.md) | Contract-assessment, findings, and disposition standard | Active | Accountable review owner | Quality Architecture and Roadmap |
| [../09-reviews/post-release-learning-records.md](../09-reviews/post-release-learning-records.md) | Real-condition release-learning record standard | Active | Product, engineering, and operations leadership | Release Plans, evidence, and reviews |

## Transitional and Operational References

| Location | Current role | Status | Successor or boundary |
|---|---|---|---|
| [../11-archive/strategy/execution-masterplan.md](../11-archive/strategy/execution-masterplan.md) | Detailed milestone-delivery context | Archived historical reference | Superseded as implementation source by the MVP Implementation Masterplan; retain only for historical work inventory. |
| [../00-constitution/governance/ENGINEERING.md](../00-constitution/governance/ENGINEERING.md) | M2 execution context | Transitional | Engineering Standards owns reusable engineering-change practice. |
| [../00-constitution/governance/CODE_STANDARDS.md](../00-constitution/governance/CODE_STANDARDS.md) | Repository-specific implementation conventions | Current implementation reference | Does not replace Engineering Standards or engineering architecture. |
| [../11-archive/foundation/](../11-archive/foundation/) | Historical product, stack, and visual implementation references | Archived historical collection | Active canonical contracts live in the 00–10 structure. |
| [../current-phase/logs/](../current-phase/logs/) | Active runbooks, operational logs, and execution context | Operational | Does not define durable product or engineering authority. |
| [../11-archive/review/](../11-archive/review/) | Historical SRAI materials and legacy review artifacts | Archived historical collection | New durable assessments use `09-reviews/`. |
| [../11-archive/design/](../11-archive/design/) | Legacy feature-design materials | Archived historical collection | New design specifications use `05-design/`. |

## Historical Locations

| Location | Historical role | Current replacement |
|---|---|---|
| [../11-archive/documentation/documentation-planning-2026-08-01.md](../11-archive/documentation/documentation-planning-2026-08-01.md) | Original proposed documentation architecture | Documentation Architecture and current folder indexes |
| [../11-archive/](../11-archive/) | Archived strategy, foundation, design, planning, runbook, and project history | Relevant active or transitional document above |
