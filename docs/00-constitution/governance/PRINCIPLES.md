...
North star: [../../00-constitution/Vision.md](../../00-constitution/Vision.md). Current outcome sequence: [../../07-strategy-and-delivery/roadmap.md](../../07-strategy-and-delivery/roadmap.md). The masterplan remains transitional milestone context.
...
- [GATES.md](./GATES.md) — per-feature definition of done
