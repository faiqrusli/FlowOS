...
| 3 | Record the decision in `docs/execution/logs/decision-log.md` (one entry: docs live at `flowos/docs/`). |
...
| 4 | Add one line to `docs/execution/logs/decision-log.md` describing archive method and date. |
