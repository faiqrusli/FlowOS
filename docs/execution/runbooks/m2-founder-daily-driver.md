...
Create `docs/execution/logs/friction-log.md` (or private sheet — if private, note location in decision log):
...
Use only when truly blocked. Record choice in `docs/execution/logs/decision-log.md`.
