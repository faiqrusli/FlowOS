...
The active [Git Workflow](../foundation/governance/GIT_WORKFLOW.md) governs repository work:
...
Formal feature, architecture, or release assessments use the [Review Records](../10-reviews/review-records.md) standard and, when helpful, the [review template](../04-features/_templates/review-template.md). A passing CI job, a reviewer recommendation, or a deployed preview is not Founder approval.
...
`main` is production truth. Follow the active [Git Workflow](../foundation/governance/GIT_WORKFLOW.md):
...
Use [Post-Release Learning Records](../10-reviews/post-release-learning-records.md), [Review Records](../10-reviews/review-records.md), and [Decision Records](../08-decisions/decision-records.md) when their respective thresholds are met.
...
|---|---|---|---|
| Product direction and immutable boundaries | [Vision](../strategy/Vision.md) | Founder | Founder |
...
| Code and repository workflow | [Engineering Standards](./engineering-standards.md), [Git Workflow](../foundation/governance/GIT_WORKFLOW.md), and active code standards | Engineer follows/updates technical detail | Founder final authority |
| Consequential choice | [Decision Records](../08-decisions/decision-records.md) | Founder with contributor facts | Founder |
| Assessment and disposition | [Review Records](../10-reviews/review-records.md) | Reviewer with factual evidence | Founder final disposition |
...
| Learning after release | [Post-Release Learning Records](../10-reviews/post-release-learning-records.md) | Engineer/designer supplies facts | Founder decides follow-up |
