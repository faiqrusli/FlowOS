...
**Authoritative visual system:** [../../foundation/DESIGN_SYSTEM.md](../../foundation/DESIGN_SYSTEM.md) (v2.0) — content-first visual architecture. Historical: [DESIGN_SYSTEM_v1.md](../../foundation/DESIGN_SYSTEM_v1.md).
